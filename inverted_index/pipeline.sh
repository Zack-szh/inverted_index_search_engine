...
INDEX_OUT="../index_server/index/inverted_index"
mkdir -p "${INDEX_OUT}"
cp output/part-00000 "${INDEX_OUT}/inverted_index_0.txt"
cp output/part-00001 "${INDEX_OUT}/inverted_index_1.txt"
cp output/part-00002 "${INDEX_OUT}/inverted_index_2.txt"
